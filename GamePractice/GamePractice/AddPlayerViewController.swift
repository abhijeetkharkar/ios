...
class AddPlayerViewController: UIViewController {
    ...
    @IBAction func submit(_ sender: UIButton) {
        ...
        if(nameText.text == nil || nameText.text == "") {
            ...
            let player:Player = Player(srNo: srNoValue, name: nameText.text!, email: emailText.text!, education: educationText.text!, major: (majorText.text == nil || majorText.text == "") ? "" : majorText.text!, dob: datePicker.date, matchesPlayed: 0, averageScore: 0.0, highScore: 0, rpn: 0.0, isActive: false, activatedOn: "", scoreList : [0,0,0,0,0])
