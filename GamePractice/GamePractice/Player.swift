...
class Player: NSObject, NSCoding {
    ...
    var scoreList:[Int] = [0,0,0,0,0]
    
    // Memberwise initializer
    init(srNo: Int, name: String, email: String, education: String, major: String, dob : Date, matchesPlayed : Int, averageScore : Double, highScore : Int, rpn : Double, isActive : Bool, activatedOn : String, scoreList : [Int]) {
        self.srNo = srNo
        self.name = name
        self.email = email
    ...
    required init(coder decoder: NSCoder) {
        ...
        scoreList = (decoder.decodeObject(forKey: "scoreList") as? [Int])!
    }
    ...
    func encode(with coder: NSCoder) {
        ...
        coder.encode(self.scoreList, forKey: "scoreList")
    }
}
