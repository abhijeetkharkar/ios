...
class MusicViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(AppDelegate.musicList.count != 0) {
            ...
            music.detailTextLabel?.text = AppDelegate.selectedGenre
                ...
                if snapshot.hasChildren() {
                    ...
                    for record in records {
                        ...
                        if(recordVal["m_category"] == "relax") {
                            AppDelegate.relaxList.append(recordVal["m_name"]! + "!#@#!" + recordVal["m_url"]!)
                        } else if(recordVal["m_category"] == "metal") {
                            AppDelegate.metalList.append(recordVal["m_name"]! + "!#@#!" + recordVal["m_url"]!)
                        } else {
                            AppDelegate.popList.append(recordVal["m_name"]! + "!#@#!" + recordVal["m_url"]!)
                        }
                        AppDelegate.allList.append(recordVal["m_name"]! + "!#@#!" + recordVal["m_url"]!)
                    }
                }
